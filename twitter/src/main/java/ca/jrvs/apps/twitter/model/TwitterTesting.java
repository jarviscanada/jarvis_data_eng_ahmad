...
public class TwitterTesting {
    ...
    public static void main(String[] args) throws IOException, OAuthCommunicationException, OAuthExpectationFailedException, OAuthMessageSignerException, InterruptedException, JSONException {
        ...
        HttpGet get_request = new HttpGet("https://api.twitter.com/1.1/statuses/show.json?id=1251611002707288069");
        ...
        Tweet tweet = mapper.readValue(j_tweet,Tweet.class);

        Coordinates c = tweet.getCoordinates();
